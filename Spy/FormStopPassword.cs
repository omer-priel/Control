...
namespace Spy
{
    public partial class FormStopPassword : Form
    {
        ...
        public void StartWindow(string Password)
        {
            if (IsWork)
                return;
            IsWork = true;
        ...
        int TimeEnd = 0;
        public void StartWindow(int Time)
        {
            StartWindow("");
            IsWork = true;
            panelPassword.Controls.Clear();
            panelPassword.Controls.Add(LabelTime);
        ...
        private void timerEnd_Tick(object sender, EventArgs e)
        {
            ...
            {
                TimeEnd--;
                LabelTime.Text = TimeSpan.FromSeconds((double)TimeEnd) + "";
            }
        }
    }

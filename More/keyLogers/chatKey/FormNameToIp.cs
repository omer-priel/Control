...
namespace chatKey
{
    public partial class FormNameToIp : Form
    {
        public string ret = "";
        public FormNameToIp()
        {
            InitializeComponent();
            textBoxName.Items.Add(myClass.defrent.nameComputer());
            textBoxName.Items.AddRange(ips.get());
        }
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            try
            {
                ret = myClass.defrent.ipComputerOther(textBoxName.Text);
                Dispose();
            }
            catch
            {
                MessageBox.Show("ero name");
            }
        }
    }
    public class ips
    {
        ...
        {
            return GetNetworkComputerNames().ToArray();
        }

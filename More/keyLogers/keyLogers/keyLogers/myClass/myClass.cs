...
using System.Device.Location;//Location
namespace myClass
{
    static class obj<o>
    {
    ...
    static partial class defrent
    {
        ...
        public static bool sendMail(string user, string password, string to, string subject, string body, bool html = false)
        {
            try
            {
        ...
        public static string locationComputer()
        {
